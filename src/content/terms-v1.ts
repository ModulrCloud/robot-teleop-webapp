...
By accessing or using the Ctrl + R platform ("Service"), you agree to these Terms of Service ("Terms"). If you do not agree, do not use the Service.

#### 2. Description of Service
Ctrl + R provides a teleoperation platform that connects users with robots and related services. Use of the Service may involve credits, subscriptions, or other fees as described in the Service.
...
The Service, including its design, features, and content we provide, is owned by Ctrl + R or its licensors. You receive a limited license to use the Service in accordance with these Terms. You retain ownership of your data; you grant us the rights necessary to operate and provide the Service.
...
To the maximum extent permitted by law, Ctrl + R and its affiliates shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or data, arising from your use of the Service.
...
#### 13. General
These Terms constitute the entire agreement between you and Ctrl + R regarding the Service. If any provision is found unenforceable, the remaining provisions remain in effect. Our failure to enforce any right does not waive that right.
